...
function seedDatabase() {
  ...
  const cs101Sessions = [
    {
      ...
      desc: 'Course overview and Python basics',
      content:
        'Welcome to CS101! In this session, we introduce Python programming language, its history, and why it is great for beginners. We will set up the development environment and write our first "Hello, World!" program.'
    },
    {
      num: 2,
      title: 'Variables and Data Types',
      desc: 'Understanding variables, strings, numbers',
      content:
        'Learn about different data types in Python including integers, floats, strings, and booleans. We will practice declaring variables, performing arithmetic operations, and string manipulations.'
    },
    {
      num: 3,
      title: 'Control Flow',
      desc: 'If statements and conditional logic',
      content:
        'Understand how to control program flow using if, elif, and else statements. We will build decision-making programs and learn about comparison operators and logical operators.'
    },
    {
      num: 4,
      title: 'Loops',
      desc: 'For loops and while loops',
      content:
        'Master iteration using for and while loops. We will practice iterating over sequences, using range(), and understanding loop control statements like break and continue.'
    },
    {
      num: 5,
      title: 'Functions',
      ...
      content:
        'Learn to write reusable code with functions. Topics include function definitions, parameters, return values, and scope. We will also cover lambda functions and built-in functions.'
    },
    {
      num: 6,
      title: 'Lists and Tuples',
      desc: 'Working with sequences',
      content:
        'Explore Python lists and tuples. Learn about indexing, slicing, list methods, and the differences between mutable and immutable sequences.'
    },
    {
      num: 7,
      title: 'Dictionaries',
      desc: 'Key-value data structures',
      content:
        'Understand dictionaries and their use cases. Practice creating, accessing, and modifying dictionaries. Learn about dictionary methods and iteration.'
    },
    {
      num: 8,
      title: 'File I/O',
      ...
      content:
        'Learn to work with files in Python. Practice opening, reading, writing, and closing files. Understand different file modes and exception handling with files.'
    },
    {
      num: 9,
      ...
      content:
        'Master exception handling in Python. Learn about try, except, finally, and raise statements. Understand common exceptions and how to handle them gracefully.'
    },
    {
      num: 10,
      title: 'Modules and Packages',
      desc: 'Code organization and imports',
      content:
        'Understand Python modules and packages. Learn to import modules, create your own modules, and explore the Python Standard Library.'
    },
    {
      num: 11,
      ...
      content:
        'Introduction to OOP concepts in Python. Learn about classes, objects, attributes, methods, inheritance, and encapsulation.'
    },
    {
      num: 12,
      title: 'Final Project',
      desc: 'Build a complete application',
      content:
        'Apply everything you have learned to build a complete Python application. Present your project to the class and receive feedback.'
    }
  ];
  ...
  cs101Sessions.forEach((session) => {
    sessionStmt.run(
      ...
      session.desc,
      session.content,
      `2026-09-${session.num.toString().padStart(2, '0')}`
    );
  });
  ...
  const cs201Sessions = [
    {
      ...
      desc: 'Course overview and abstract data types',
      content:
        'Welcome to CS201! This course covers essential data structures used in computer science. We will discuss abstract data types, algorithm analysis, and Big-O notation.'
    },
    {
      num: 2,
      ...
      content:
        'Compare arrays and linked lists. Understand their implementations, time complexities, and use cases. Practice implementing singly and doubly linked lists.'
    },
    {
      num: 3,
      title: 'Stacks',
      desc: 'LIFO data structure',
      content:
        'Learn about stacks and their applications. Implement stack operations (push, pop, peek) using arrays and linked lists. Explore real-world use cases like function call stacks.'
    },
    {
      num: 4,
      title: 'Queues',
      desc: 'FIFO data structure',
      content:
        'Understand queues, priority queues, and deques. Implement queue operations and explore applications like task scheduling and breadth-first search.'
    },
    {
      num: 5,
      title: 'Recursion',
      desc: 'Recursive problem solving',
      content:
        'Master recursive thinking and implementation. Practice writing recursive functions, understand base cases, and analyze recursive algorithms.'
    },
    {
      num: 6,
      title: 'Trees',
      ...
      content:
        'Introduction to tree structures including binary trees, binary search trees, and tree traversal algorithms (inorder, preorder, postorder).'
    },
    {
      num: 7,
      title: 'Balanced Trees',
      desc: 'AVL trees and Red-Black trees',
      content:
        'Learn about self-balancing trees. Understand rotations, balance factors, and the importance of balanced trees for performance.'
    },
    {
      num: 8,
      title: 'Heaps',
      ...
      content:
        'Explore heap data structures and their applications. Implement heap operations and use heaps to implement efficient priority queues.'
    },
    {
      num: 9,
      title: 'Hash Tables',
      desc: 'Fast lookup data structures',
      content:
        'Understand hash tables, hash functions, and collision resolution strategies. Analyze time complexity and implement a hash table from scratch.'
    },
    {
      num: 10,
      title: 'Graphs',
      desc: 'Graph representation and traversal',
      content:
        'Introduction to graph theory and graph data structures. Learn adjacency lists and adjacency matrices. Implement graph traversal algorithms.'
    },
    {
      num: 11,
      title: 'Graph Algorithms',
      desc: 'BFS, DFS, and shortest path',
      content:
        'Study common graph algorithms including breadth-first search, depth-first search, Dijkstra algorithm, and minimum spanning trees.'
    },
    {
      num: 12,
      title: 'Algorithm Analysis',
      desc: 'Review and comparison',
      content:
        'Review all data structures covered in the course. Compare their time and space complexities. Discuss when to use each data structure in practice.'
    }
  ];
  ...
  const cs301Sessions = [
    {
      ...
      desc: 'Security fundamentals and threat landscape',
      content:
        'Welcome to CS301! This course covers essential security concepts for modern applications. We will explore the CIA triad, threat modeling, and the current security landscape.'
    },
    {
      num: 2,
      title: 'Authentication Basics',
      desc: 'Passwords and credential management',
      content:
        'Learn about authentication mechanisms. Understand password storage, hashing algorithms (bcrypt, scrypt), and best practices for credential management.'
    },
    {
      num: 3,
      ...
      desc: 'MFA and TOTP',
      content:
        'Explore multi-factor authentication methods. Implement TOTP-based MFA using Google Authenticator. Understand the security benefits of MFA.'
    },
    {
      num: 4,
      title: 'Authorization and Access Control',
      desc: 'RBAC and permissions',
      content:
        'Study authorization mechanisms including role-based access control (RBAC) and attribute-based access control (ABAC). Learn to implement proper access controls.'
    },
    {
      num: 5,
      title: 'Encryption Fundamentals',
      desc: 'Symmetric and asymmetric encryption',
      content:
        'Understand encryption concepts including symmetric encryption (AES), asymmetric encryption (RSA), and when to use each. Practice encrypting sensitive data.'
    },
    {
      num: 6,
      title: 'Encryption in Transit',
      desc: 'TLS/SSL and HTTPS',
      content:
        'Learn about transport layer security. Understand how HTTPS works, certificate authorities, and implementing secure communication in applications.'
    },
    {
      num: 7,
      title: 'Encryption at Rest',
      desc: 'Database encryption and key management',
      content:
        'Explore data encryption strategies for stored data. Learn about database encryption, file encryption, and secure key management practices.'
    },
    {
      num: 8,
      title: 'OWASP Top 10: Injection',
      desc: 'SQL injection and prevention',
      content:
        'Study injection attacks, particularly SQL injection. Learn how to prevent injection vulnerabilities using parameterized queries and input validation.'
    },
    {
      num: 9,
      title: 'OWASP Top 10: XSS and CSRF',
      desc: 'Cross-site scripting and request forgery',
      content:
        'Understand XSS and CSRF attacks. Learn prevention techniques including output encoding, content security policy, and CSRF tokens.'
    },
    {
      num: 10,
      title: 'Session Management',
      desc: 'Secure sessions and tokens',
      content:
        'Learn about secure session management, JWT tokens, and session hijacking prevention. Implement secure session handling in web applications.'
    },
    {
      num: 11,
      title: 'Security Monitoring',
      desc: 'Logging and audit trails',
      content:
        'Understand the importance of security monitoring and audit logging. Learn what events to log, how to protect logs, and using logs for incident response.'
    },
    {
      num: 12,
      title: 'Security Best Practices',
      desc: 'Defense in depth and secure SDLC',
      content:
        'Review security best practices including defense in depth, principle of least privilege, and integrating security throughout the software development lifecycle.'
    }
  ];
  ...
  const scaFindings = [
    [
      ...
      'Semgrep',
      'Move the secret to an environment variable (SESSION_SECRET). Generate a cryptographically random 64-byte value for production.',
      null
    ],
    ...
    [
      ...
      'Semgrep',
      'Load the key from an environment variable (ENCRYPTION_KEY). Use a key derivation function (PBKDF2/Argon2) if deriving from a passphrase.',
      null
    ],

    [
      3,
      'Plaintext Credentials Logged to Console',
      'server.js',
      141,
      '    const security = {\n' +
      ...
      'Semgrep',
      'Remove the password from the log statement. Log only the username and outcome (success/failure).',
      null
    ],
    ...
    [
      ...
      'Semgrep',
      'Hash passwords with bcrypt/argon2 on registration. Compare using bcrypt.compare() at login. Migrate existing users on next login.',
      null
    ],
    ...
    [
      ...
      'Manual Review',
      'Change the default to audit_logging: 1. Document the intentional-off toggle in the Security Panel as a teaching tool only.',
      null
    ],

    [
      6,
      'IDOR: No Ownership Check on Enrollment Access',
      'routes/classes.js',
      39,
      ...
      'Semgrep',
      'Replace req.params.studentId with req.session.userId. Verify resource ownership before returning data.',
      null
    ],
    ...
    [
      ...
      'Manual Review',
      'Add the csurf middleware (or a modern equivalent like csrf-csrf). Include the token in all forms and AJAX requests.',
      null
    ],

    [
      8,
      'Rate Limiting Only on Login Route',
      ...
      'Manual Review',
      'Apply rate limiting globally or to all sensitive endpoints. Use different limits per endpoint based on sensitivity.',
      null
    ],
    ...
    [
      ...
      'Semgrep',
      "Add the helmet middleware: app.use(helmet()). Configure Content-Security-Policy for the application's specific sources.",
      null
    ],
    ...
    [
      ...
      'Semgrep',
      'Validate that the resolved path starts with BACKUP_DIR: assert(filepath.startsWith(BACKUP_DIR)). Reject requests with path separators in the filename.',
      null
    ],

    [
      11,
      'Outdated express-session with Known Vulnerabilities',
      'package.json',
      24,
      '  "dependencies": {\n' +
        '    "express": "^4.18.2",\n' +
      ...
      'npm audit',
      'Run npm audit fix. Pin to the latest stable version. Add npm audit to the CI pipeline to catch regressions.',
      null
    ],
    ...
    [
      ...
      'Semgrep',
      'Set secure: process.env.NODE_ENV === "production" so the flag is active in production HTTPS deployments while remaining usable in local HTTP dev.',
      null
    ]
  ];
  ...
  const dastScenarios = [
    [
      1,
      "IDOR: Access Another Student's Grades",
      ...
      '/classes',
      'Student can read grade records belonging to other users without authorisation',
      'routes/classes.js',
      '39-55',
      '7.5',
      1
    ...
    [
      ...
      '/admin/backup',
      'Plaintext passwords visible in the database backup',
      'config/database.js',
      '225-243',
      '9.1',
      1
    ...
    [
      3,
      'CSRF: Force Admin to Disable Security Feature',
      ...
      '/admin/security',
      'Security settings can be changed by a forged cross-origin request',
      'server.js',
      '1-50',
      '8.8',
      1
    ...
    [
      4,
      'Brute Force MFA Verification (No Rate Limit)',
      'Brute Force',
      ...
      '/auth/verify-mfa',
      'MFA verification accepts unlimited attempts with no lockout',
      'middleware/rateLimiter.js',
      '1-30',
      '6.5',
      1
    ...
    [
      ...
      '/admin/audit-logs',
      'User passwords appear in plaintext in application logs',
      'server.js',
      '135-145',
      '7.5',
      1
    ...
    [
      6,
      'Path Traversal: Read Arbitrary Server Files via Backup Download',
      'Path Traversal',
      'A01:2021 - Broken Access Control',
      'High',
  ...
  const vmVulns = [
    ...
    [
      ...
      null,
      1,
      'Migrate to environment variable ENCRYPTION_KEY',
      null,
      now,
      now
    ],
    ...
    [
      6,
      'CSRF on Security Settings Endpoint',
      'dast',
      3,
      'A01:2021 - Broken Access Control',
      'CWE-352',
    ...
    [
      ...
      null,
      3,
      'Add rate limiting to /auth/verify-mfa',
      null,
      now,
      now
    ],
    ...
    [
      11,
      'Outdated express-session Dependency',
      'sca',
      11,
      ...
      null,
      4,
      'Accepted risk for classroom demo; revisit before production use',
      null,
      now,
      now
    ],
